import {
	...
	Quaternion,
	Vector3
} from "../libs/three.js/r131/three.module.js";
	...
	constructor( object, domElement ) {
		...
		this.keydown = function ( event ) {
			...
			switch ( event.code ) {
				...
				case 'KeyW': this.moveStatew.forward = 1; break;
		...
		this.updateMovementVector = function () {
			...
			const forward = ( this.moveState.forward || ( this.autoForward && ! this.moveState.back ) ) ? .01 : 0;
